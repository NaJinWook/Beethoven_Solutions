...
namespace WindowsFormsApp1
{
    ...
    public partial class Form_login : Form
    {
        ...
        public Form_login()
        {
            ...
            //this.BackgroundImage = (Bitmap)WindowsFormsApp1.Properties.Resources.ResourceManager.GetObject("login_bg");
        ...
        private void Form_login_Load(object sender, EventArgs e)
        {
            ...
            arr.Add(new ob_Pnl(this, "", "", 280, 360, 150, 20));
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    ...
                    num_btn.BackColor = Color.FromArgb(200, 165, 5, 10);
        ...
        private void option()
        {
            ...
            pnl.BackColor = Color.FromArgb(9, 29, 81);
        ...
        private void fonts()
        {
            ft = new PrivateFontCollection();
            ft2 = new PrivateFontCollection();

            ft.AddFontFile("Font\\Christmas_font.ttf");
            ft2.AddFontFile("Font\\gabia_solmee.ttf");

            font = new Font(ft.Families[0], 24);
            font2 = new Font(ft2.Families[0], 24);
        }
